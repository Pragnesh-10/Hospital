...
export interface Database {
  public: {
    Tables: {
      ...
      appointments: {
        Row: { id: string; patient_id: string | null; doctor_id: string; appointment_date: string; appointment_time: string; status: string; reason: string | null; guest_name: string | null; guest_email: string | null; guest_phone: string | null; guest_city: string | null; guest_state: string | null; guest_country: string | null; appointment_number: string | null; medical_notes: string | null; created_at: string }
